...
def run(weights=ROOT / 'yolov5l.pt',  # model.pt path(s)
        source=ROOT / 'data/images/1001.jpg',  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    #parser.add_argument('--source', type=str, default=ROOT / 'E:\Liu_pro\laber_images', help='file/dir/URL/glob, 0 for webcam')
